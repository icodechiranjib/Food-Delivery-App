package com.chiranjib.fooddelivery.adapter
...
import com.chiranjib.fooddelivery.activity.RestaurantMenuActivity
import com.chiranjib.fooddelivery.database.RestaurantDatabase
import com.chiranjib.fooddelivery.database.RestaurantEntity
import com.chiranjib.fooddelivery.model.Restaurant
...
class DashboardFragmentAdapter(val context: Context, var itemList: ArrayList<Restaurant>) :
    ...
    override fun onBindViewHolder(holder: ViewHolderDashboard, position: Int) {
        ...
        Picasso.get().load(restaurant.restaurantImage).error(R.drawable.ic_default_img_res)
